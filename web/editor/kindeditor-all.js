...
K.options = {
	...
	*/
	...
	items : [
		'source', '|', 'undo', 'redo', '|', 'preview', 'code', 'wordpaste', 'insertorderedlist', 'insertunorderedlist', 'quickformat', 'hr', 'emoticons', 'baidumap', 'pagebreak', 'link', '|', 'fullscreen', '/',
		'formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold','italic', 'underline', 'strikethrough', 'lineheight', 'removeformat', '|', 'image', 'media', 'insertfile', 'table'
	],
